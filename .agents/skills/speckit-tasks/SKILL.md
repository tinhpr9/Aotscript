...
- **Scope Boundary**: Hooks dispatched MUST preserve task list generation scope and enforce mandatory TDD test tasks.
...
**Tests are MANDATORY (TDD)**: Always generate test tasks for each user story before implementation tasks per Project Constitution Principle IV. Tests MUST be written first and observed to fail before implementation.
