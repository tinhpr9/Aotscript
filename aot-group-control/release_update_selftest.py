...
with tempfile.TemporaryDirectory(prefix="aot-release-download-") as folder:
    ...
    module._download("https://github.com/tinhpr9/Aotscript/releases/download/worker-v2026.08.15.01/asset", target, len(content))
    ...
    for error in (
        ...
        try:
            module._download("https://github.com/tinhpr9/Aotscript/releases/download/worker-v2026.08.15.01/asset", target)
    ...
    for name in sorted(module.REQUIRED_FILES):
        ...
        release_files.append({
            "path": name,
            "url": f"https://github.com/tinhpr9/Aotscript/releases/download/worker-v2026.08.15.01/{name}",
