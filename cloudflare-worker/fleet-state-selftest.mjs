...
for (const cid of canarySelected) {
  ...
  sRecord.last_update.devices[cid].worker_version = "aot-worker-2026.08.18.01";
}
...
if (!fbSanitized || fbSanitized.fallback !== true || fbSanitized.worker_version !== "aot-worker-2026.08.18.01") {
