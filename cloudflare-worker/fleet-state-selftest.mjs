...
fleet.resolveWorkerRelease = async () => ({ version: "aot-worker-2026.08.23.01", hash: "mock" });
...
for (const cid of canarySelected) {
  ...
  sRecord.last_update.devices[cid].worker_version = "aot-worker-2026.08.23.01";
}
...
if (!fbSanitized || fbSanitized.fallback !== true || fbSanitized.worker_version !== "aot-worker-2026.08.23.01") {
