...
# 1. We will replace everything from "class TestRestoreDataFilterActive(" 
# down to "class TestLegacyActionsUnchanged(" with our new tests and a fixed TestRelayBackupRestoreData

start_idx = src.find("class TestRestoreDataFilterActive(")
end_idx = src.find("class TestLegacyActionsUnchanged(")
...
"""
src = src[:start_idx] + new_tests + src[end_idx:]
