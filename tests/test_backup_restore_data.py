...
class TestArchitectureConstraints(unittest.TestCase):
    ...
    def test_worker_version_bumped_to_11(self):
        self.assertEqual("aot-worker-2026.08.11.11", RELAY.WORKER_VERSION)
    ...
    def test_fleet_state_version_bumped(self):
        ...
        self.assertIn("aot-worker-2026.08.11.11", src)
        self.assertIn("worker-v2026.08.11.11", src)
